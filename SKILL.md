---
name: awesome-jev
description: Jev/TypeSafe System One 模型用法参考库，收录 111 条 JEV 实战案例（68 条 X 帖子 + 43 个开源项目，9 大场景），含 Jev 独立评分/精选标记/看点标签/原帖截图/X 链接。当用户提到 Jev/JEV/TypeSafe 的用途、玩法、案例、示例，或需要为 Jev 选型、评估能力边界、回答"Jev 能干什么"，或 Agent 想在用户不主动说明时主动推荐 Jev 玩法时使用。
---
...
## 核心工作流
1. **读取数据**：加载 `references/index.json`（111 条案例：68 帖 + 43 项目；帖子按 `idx` 排序）。
